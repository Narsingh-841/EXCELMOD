...
//    }
	...
	private static void writeCSVFile(Set<AssetData> assetListSet ,File inputFile,File outputDirectory) {
	    ...
	    // Populating data from assetListSet
	    ...
	    // Check for parentheses and append " notice"
	    ...
	    String outputFilePath = outputDirectory.getAbsolutePath() + File.separator + inputFileNameWithoutExtension + ".csv";
	        ...
	        String[] header = {"*AssetName", "*AssetNumber", "PurchaseDate", "PurchasePrice", "AssetType",
	                            "Description", "TrackingCategory1", "TrackingOption1", "TrackingCategory2", 
	                            "TrackingOption2", "SerialNumber", "WarrantyExpiry", "Book_DepreciationStartDate", 
	                            "Book_CostLimit", "Book_ResidualValue", "Book_DepreciationMethod", 
	                            "Book_AveragingMethod", "Book_Rate", "Book_EffectiveLife", 
